...
class TestRelevant(unittest.TestCase):
    def test_random_relevant(self):
        transactions_mini = pd.DataFrame(
            {
                "t_dat": [
                    "2023-09-09",
                    "2023-08-10",
                ...
                "customer_id": ["1a", "1a", "02", "1a", "02"],
                "article_id": ["01", "02", "03", "04", "05"],
                "price": [0.015, 0.017, 0.07, 0.03, 0.01],
                "sales_channel_id": [1, 1, 2, 2, 1],
            }
        )
        ...
        actual = mini_relevant_val.target[
            mini_relevant_val.customer_id == "02"
        ].to_list()
